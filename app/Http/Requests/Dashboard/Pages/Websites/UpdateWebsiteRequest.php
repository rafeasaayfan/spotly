    ...
    public function rules(): array
    {
        return [
            ...
            'name' => [
                ...
                'regex:/^[A-Za-z0-9]+$/',
                Rule::unique('websites', 'name')->ignore($this->route('website')->id)
            ],
            'subdomain' => [
                'required',
                'string',
                ...
                'regex:/^(?!-)[a-z0-9-]+(?<!-)$/',
                Rule::unique('websites', 'subdomain')->ignore($this->route('website')->id)
            ],
            ...
            'email' => [
                ...
                'email:rfc,dns',
                'min:3',
                Rule::unique('websites', 'email')->ignore($this->route('website')->id)
            ],
