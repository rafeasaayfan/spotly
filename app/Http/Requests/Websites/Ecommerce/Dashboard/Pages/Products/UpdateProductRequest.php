...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        foreach ($variants as $index => $variant) {
            ...
            $messages["variants.{$index}.id.integer"] = "Variant {$variantNumber} ID must be a valid integer.";
            $messages["variants.{$index}.id.exists"] = "Variant {$variantNumber} does not exist.";
            ...
            if (isset($variant['ecommerce_product_images']) && is_array($variant['ecommerce_product_images'])) {
                foreach ($variant['ecommerce_product_images'] as $imgIndex => $img) {
                    ...
                    $messages["variants.{$index}.ecommerce_product_images.{$imgIndex}.id.integer"] = "Variant {$variantNumber} image {$imageNumber} ID must be a valid integer.";
