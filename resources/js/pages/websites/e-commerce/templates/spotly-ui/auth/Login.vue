    ...
    <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <div class="flex items-center justify-between">
                        ...
                        <TextLink v-if="props.canResetPassword" :href="route('website.password.request')" class="text-sm" :tabindex="5">
                            Forgot password?
                        </TextLink>
                    </div>
                    <Input
            ...
            <div class="text-center text-sm flex items-center justify-center gap-2">
                ...
                <TextLink :href="route('website.register')" :tabindex="5">Sign up</TextLink>
            </div>
        </form>
