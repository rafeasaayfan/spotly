...
onMounted(() => {
    ...
    gsap.utils.toArray<HTMLElement>('.eco-section-title-underline').forEach((title) => {
...
.eco-glow-button {
    ...
    background-image: linear-gradient(
        to right,
        var(--primary_light) 50%,
        var(--primary_hover_light) 80%,
        var(--primary_hover_light) 100%
    );
}
.dark .eco-glow-button {
    ...
    background-image: linear-gradient(
        to right,
        var(--primary_dark) 50%,
        var(--primary_hover_dark) 80%,
        var(--primary_hover_dark) 100%
    );
}
