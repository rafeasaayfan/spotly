...
<template>
    <section id="hero" class="relative z-5 flex grid min-h-[100vh] w-full grid-cols-5 pt-22 pb-22 backdrop-blur md:pt-28">
        ...
        <div v-if="props.specialProducts && props.specialProducts.length > 0" class="col-span-5">
            <div class="col-span-3 flex flex-col">
                <div
                    ...
                    class="horizontal-carousel-track relative flex gap-0 overflow-x-scroll px-0 py-0 md:gap-10 md:px-10 md:py-5"
                >
                    <SpecialProductCard v-for="(product, index) in props.specialProducts" :key="`${product.id}-${index}`" :product="product" />
                </div>
                ...
                <div class="flex flex-col items-center gap-1">
                    ...
                    <Link
                        href="/shop?special=true"
                        class="group web-text-body flex cursor-pointer items-center gap-0.5 text-xs font-medium underline underline-offset-2"
                    >
        ...
        <div class="absolute bottom-0 flex w-full items-center justify-center pb-15">
            <ChevronDown class="web-text-body-muted size-5 animate-bounce" />
        </div>
    </section>
