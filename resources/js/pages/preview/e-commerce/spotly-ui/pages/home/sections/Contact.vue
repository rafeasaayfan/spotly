...
<template>
    <section id="contact" class="section-animate flex flex-col gap-4 py-22">
        ...
        <!-- <div class="lg:col-span-1">
                ...
                >
                    <h3 class="web-text-active border-muted mb-5 border-b pb-3 text-2xl font-bold">Contact Information</h3>
                    ...
                    <div class="space-y-4">
                        <a href="mailto:support@spotly.com" class="contact-method-card flex items-start space-x-4 cursor-pointer px-2 py-2 rounded-md hover:bg-white/8">
                            ...
                            <div>
                                <h4 class="font-semibold web-text-active">Email</h4>
                                <p class="web-text-active-link text-sm">support@spotly.com</p>
                            </div>
                        </a>
                        ...
                        <a href="tel:+1 (555) 123-4567" class="contact-method-card flex items-start space-x-4 cursor-pointer px-2 py-2 rounded-md hover:bg-white/8">
                            ...
                            <div>
                                <h4 class="font-semibold web-text-active">Phone</h4>
                                <p class="web-text-active-link text-sm">+1 (555) 123-4567</p>
                            </div>
                        </a>
                        ...
                        <div class="contact-method-card flex items-start space-x-4 px-2 py-2 rounded-md hover:bg-white/8">
                            ...
                            <div>
                                <h4 class="font-semibold web-text-active">Address</h4>
        ...
        <!-- Contact Form -->
        <div class="rounded-md px-6 py-10 shadow bg-[var(--bg_nav_light)]/60 dark:bg-[var(--bg_nav_dark)]/60">
            <!-- Header -->
            <div class="mb-14 flex w-full flex-col items-center justify-center gap-1">
                <h2 class="web-text-active web-section-title-underline text-3xl font-bold md:text-5xl">
                    Get In
                    <span class="web-gradient-text">Touch</span>
                </h2>

                <p class="web-text-body-muted">Have questions or ready to start shopping? We'd love to hear from you!</p>
            </div>
            ...
            <form @submit.prevent="submitForm" class="contact-form mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    class="h-11 web-bg-field" :class="form.errors.name ? 'border-[var(--destructive)]' : ''" />
                ...
                <div>
                    ...
                    class="h-11 web-bg-field" :class="form.errors.email ? 'border-[var(--destructive)]' : ''" />
                ...
                <div>
                    ...
                    class="h-11 web-bg-field" :class="form.errors.subject ? 'border-[var(--destructive)]' : ''" />
                ...
                <div class="flex flex-col items-start gap-1">
                    ...
                    class="h-11 web-bg-field" :class="form.errors.type ? 'border-[var(--destructive)]' : ''">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <Textarea class="web-bg-field" id="message" v-model="form.message" rows="6" required placeholder="Tell us more about your inquiry..."
                ...
                <div class="col-span-1 md:col-span-2 flex justify-end">
                    <Button type="submit" size="lg" class="web-glow-button">
                        <Send class="size-4" />
