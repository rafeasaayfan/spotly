        ...
        <div class="border-muted relative z-10 grid grid-cols-1 gap-5 border-b px-4">
            ...
            <div class="border-muted grid gap-4">
                ...
                <div class="border-muted flex flex-col gap-3 border-t border-b py-4">
                    <p class="text-body-muted flex w-full items-center justify-between text-sm">
                        Payment Amount: <span class="text-body text-base font-medium">{{ props.data.amount }}$</span>
                    </p>
                    
                    <p v-if="props.data.paid_at" class="text-body-muted flex w-full items-center justify-between text-sm">
                        Paid At: <span class="text-body text-base font-medium">{{ formatters.date(props.data.paid_at, 'long') }}</span>
                    </p>
                </div>
            </div>
        </div>
